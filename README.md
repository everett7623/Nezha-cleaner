...
- 🛡️ **安全可靠** - v1.3 精准叶子目录保护 + `safe_remove()` 统一安全删除，杜绝误删
- 🔎 **智能路径追踪** - 通过 `/proc/{pid}/exe` 和 systemd 服务文件自动发现非标准安装路径
- 🌐 **双语支持** - 同时显示中文和英文提示信息
...
### v1.3 不会删除以下文件 (v1.3 Will NOT Delete)
...
|------|------|------|------|------|
| 基础清理功能 | ✅ | ✅ | ✅ | ✅ |
| 精确匹配nezha文件 | ⚠️ 部分 | ✅ 完全 | ✅ 完全 | ✅ 完全 |
| 避免误删系统文件 | ❌ 有风险 | ✅ 安全 | ✅ 安全 | ✅ 安全 |
| 二次确认机制 | ❌ | ✅ | ✅ | ✅ |
| Docker容器精确识别 | ⚠️ 宽泛 | ✅ 精确 | ✅ 精确 | ✅ 精确 |
| 智能路径追踪 | ❌ | ❌ | ✅ | ✅ |
| 系统目录保护 | ❌ | ❌ | ✅ | ✅ (精准叶子级) |
| curl-pipe 交互支持 | ❌ | ❌ | ❌ | ✅ |
| 统一安全删除 `safe_remove()` | ❌ | ❌ | ❌ | ✅ |
...
A: v1.3版本已修复所有已知的误删问题，只会删除包含"nezha"的文件，不会影响其他软件。
</details>
